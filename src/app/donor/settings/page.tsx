  ...
  return (
    <div className="p-6 max-w-2xl mx-auto space-y-6">
      ...
      <div className="bg-white rounded-2xl shadow p-6 space-y-4">
        ...
        <div className="space-y-3">
          ...
          <div>
            ...
            <input
              type="email"
              placeholder="sonakshi@example.com"
              className="w-full mt-1 px-4 py-2 border rounded-lg focus:outline-none focus:ring-2 focus:ring-green-400"
            />
          </div>
          <div>
      ...
      <div className="bg-white rounded-2xl shadow p-6 space-y-4">
        ...
        <div className="flex items-center justify-between">
          <div>
            <p className="text-gray-700 font-medium">Email Alerts</p>
            <p className="text-sm text-gray-400">Receive donation summaries via email</p>
          </div>
          <button
            onClick={() => setEmailAlerts(!emailAlerts)}
            className={`w-12 h-6 rounded-full transition-colors ${emailAlerts ? "bg-green-500" : "bg-gray-300"}`}
          >
      ...
      {/* Danger Zone */}
      <div className="bg-white rounded-2xl shadow p-6 space-y-3 border border-red-100">
